...
| **AI Rival** | Independent lap-time generator (no physics) | Base 31200ms/lap (~78 ticks); difficulty sets pace ± variance |
...
- **Pace factor** scales the base lap time (31200ms): `time = base / paceFactor`
