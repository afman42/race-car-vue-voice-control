...
const messages = {
  en: {
    ...
    "msg.damageStatus": ({ damage, status }) =>
      `Car damage is ${damage} percent, ${status}.`,
    "msg.weatherStatus": ({ weather }) => `Current weather is ${weather}.`,
    "msg.weatherSet": ({ label }) => `Weather set to ${label}.`,
    "msg.unknownWeather": ({ condition }) =>
      `Unknown weather condition: ${condition}.`,
    ...
    "msg.unknownDifficulty": ({ level }) =>
      `Unknown difficulty: ${level}.`,
    "msg.aiOff": "No AI rival in this race.",
    "msg.aiStatusNoLap": ({ difficulty, lap, total }) =>
      `${difficulty} rival is on lap ${lap} of ${total}.`,
    "msg.aiStatus": ({ difficulty, lap, total, best }) =>
      `${difficulty} rival is on lap ${lap} of ${total}, best lap ${best}.`,
    ...
    "msg.help":
      ...
      "best lap, temperature, fuel, battery, weather, damage, " +
      "rival easy, rival medium, rival hard, random rival, rival off, " +
      "and reset.",
  ...
  id: {
    ...
    "ui.noLaps": "Belum ada lap selesai.",
    ...
    "msg.lapRecorded": ({ time }) => `Lap selesai dalam ${time}.`,
    "msg.fastestLap": ({ time }) => `Lap tercepat baru. ${time}.`,
    "msg.damageStatus": ({ damage, status }) =>
      `Kerusakan mobil ${damage} persen, ${status}.`,
    "msg.weatherStatus": ({ weather }) => `Cuaca saat ini ${weather}.`,
    "msg.weatherSet": ({ label }) => `Cuaca diatur ke ${label}.`,
    "msg.unknownWeather": ({ condition }) =>
      `Kondisi cuaca tidak dikenal: ${condition}.`,
    ...
    "msg.unknownDifficulty": ({ level }) =>
      `Tingkat kesulitan tidak dikenal: ${level}.`,
    "msg.aiOff": "Tidak ada lawan AI di balapan ini.",
    "msg.aiStatusNoLap": ({ difficulty, lap, total }) =>
      `Lawan ${difficulty} berada di lap ${lap} dari ${total}.`,
    "msg.aiStatus": ({ difficulty, lap, total, best }) =>
      `Lawan ${difficulty} berada di lap ${lap} dari ${total}, lap tercepat ${best}.`,
    ...
    "msg.help":
      ...
      "lap tercepat, suhu, bahan bakar, baterai, cuaca, kerusakan, lawan, dan atur ulang.",
